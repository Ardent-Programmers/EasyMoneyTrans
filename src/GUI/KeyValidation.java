...
//        ??when nextButton clicked
            ...
            try{
                ...
                isExist = ApplicationManager.DBManager.c.isLoginCorrect(ApplicationManager.DBManager.cust.AccountNo,Key);
                
                ApplicationManager.incrementAttempt();
                
                if(isExist)
                {
                  ApplicationManager.InitializeCustomer(ApplicationManager.DBManager.cust.AccountNo);
